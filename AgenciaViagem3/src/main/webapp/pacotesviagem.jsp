							...
							<div class="modal fade" id="ExcluirModal${pv.id}" tabindex="-1"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<p>Atenção! Você está prestes a excluir o pacote.</p>
										</div>
							...
							<div class="modal fade" id="AtualizarModal${pv.id}" tabindex="-1"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<!-- Formulário de Atualização (mesmo código do modal de cadastro) -->
											<form action="pacotesviagem-save">
												<div class="form-group">
												...
												<div class="form-group">
													<label for="preco">Preço:</label> <input type="text"
														class="form-control" id="preco" name="preco"
														placeholder="Preço" value="${pv.preco}">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label for="duracao">Duração:</label> <input type="text"
														class="form-control" id="duracao" name="duracao"
														placeholder="Duração" value="${pv.duracao}">
												</div>
												<div class="form-group">
													<label for="descricao">Descrição:</label>
													<textarea class="form-control" id="descricao"
														name="descricao" placeholder="Descrição">${pv.descricao}</textarea>
												</div>
